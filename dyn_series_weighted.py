...
print(abs(dyn_df_weighted(y_all, type='geometric')[-1] - dyn_seri_weighted(y_all.loc[20-1, :], type='geometric')) < 0.0001, '\n')

print(dyn_df_weighted(y_all, type='arithmetic'))
print(dyn_seri_weighted(y_all.loc[20-1, :], type='arithmetic'))
print(abs(dyn_df_weighted(y_all, type='arithmetic')[-1] - dyn_seri_weighted(y_all.loc[20-1, :], type='arithmetic')) < 0.0001, '\n')
...
print(abs(dyn_df_weighted(y_all, w=np.ones(len(k_mul)), type='arithmetic')[-1] - dyn_seri_weighted(y_all.loc[20-1, :], w=np.ones(len(k_mul)), type='arithmetic')) < 0.0001, '\n')

print(dyn_df_weighted(y_all, w=np.ones(len(k_mul))))
print(dyn_seri_weighted(y_all.loc[20-1, :], w=np.ones(len(k_mul))))
print(abs(dyn_df_weighted(y_all, w=np.ones(len(k_mul)))[-1] - dyn_seri_weighted(y_all.loc[20-1, :], w=np.ones(len(k_mul)))) < 0.0001, '\n')
